    ...
    fn roundtrip_one_of_each_record_type() {
        block_on(async {
            ...
            pending.usage_credit.push(Box::new(UsageCreditBucket {
                ...
                increment_count: 3,
                u_left_click_count: 0,
                u_right_click_count: 0,
                u_left_drag: Duration::ZERO,
                u_right_drag: Duration::ZERO,
                u_left_key_count: 0,
                u_right_key_count: 0,
                u_unclassified_key_count: 0,
                u_left_combo_count: 0,
                u_right_combo_count: 0,
                u_unclassified_combo_count: 0,
                u_left_scroll_count: 0,
                u_right_scroll_count: 0,
                ...
                cb_left: Credit::default(),
                cb_right: Credit::default(),
                cb_unclassified: Credit::default(),
                cx_left: Credit::default(),
                cx_right: Credit::default(),
                cx_unclassified: Credit::default(),
                max_increment_left_key_count: 5,
                max_increment_right_key_count: 4,
                max_increment_unclassified_key_count: 2,
                max_increment_left_combo_count: 3,
                max_increment_right_combo_count: 2,
                max_increment_unclassified_combo_count: 1,
                max_increment_left_click_count: 4,
                max_increment_right_click_count: 3,
                max_increment_left_scroll_count: 2,
                max_increment_right_scroll_count: 1,
