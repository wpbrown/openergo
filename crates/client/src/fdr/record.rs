...
pub struct UsageCreditBucket {
    ...
    pub u_left_click_count: u64,
    pub u_right_click_count: u64,
    pub u_left_drag: Duration,
    pub u_right_drag: Duration,
    pub u_left_key_count: u64,
    pub u_right_key_count: u64,
    pub u_unclassified_key_count: u64,
    pub u_left_combo_count: u64,
    pub u_right_combo_count: u64,
    pub u_unclassified_combo_count: u64,
    pub u_left_scroll_count: u64,
    pub u_right_scroll_count: u64,
    ...
    pub cb_left: Credit,
    pub cb_right: Credit,
    pub cb_unclassified: Credit,
    pub cx_left: Credit,
    pub cx_right: Credit,
    pub cx_unclassified: Credit,
    pub max_increment_left_key_count: u64,
    pub max_increment_right_key_count: u64,
    pub max_increment_unclassified_key_count: u64,
    pub max_increment_left_combo_count: u64,
    pub max_increment_right_combo_count: u64,
    pub max_increment_unclassified_combo_count: u64,
    pub max_increment_left_click_count: u64,
    pub max_increment_right_click_count: u64,
    pub max_increment_left_scroll_count: u64,
    pub max_increment_right_scroll_count: u64,
